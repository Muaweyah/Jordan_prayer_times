...
enum class JordanGovernorates(
    ...
    AMMAN("عَمّان", 31.9539, 35.9106, "عمان/الزرقاء - البلقاء/مأدبا"),
    IRBID("إربد", 32.5556, 35.8500, "إربد"),
    ZARQA("الزرقاء", 32.0728, 36.0880, "عمان/الزرقاء - البلقاء/مأدبا"),
    BALQA("البلقاء", 32.0392, 35.7272, "عمان/الزرقاء - البلقاء/مأدبا"),
    AQABA("العقبة", 29.5321, 35.0063, "العقبة/القويرة"),
    MAAN("معان", 30.1949, 35.7342, "معان - الحسينية/المدورة"),
    KARAK("الكرك", 31.1853, 35.7048, "الكرك/القطرانة"),
    TAFILAH("الطفيلة", 30.8374, 35.6181, "الطفيلة/الحسا"),
    MADABA("مأدبا", 31.7157, 35.7939, "عمان/الزرقاء - البلقاء/مأدبا"),
    JERASH("جرش", 32.2811, 35.8992, "جرش وعجلون"),
    ...
    QAFQAFA( 32.3485, 35.9386, "جرش وعجلون"),
